...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.ChartBehavior+GestureListener, Syncfusion.SfChart.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", ChartBehavior_GestureListener.class, __md_methods);
	}


	public ChartBehavior_GestureListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ChartBehavior_GestureListener.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.ChartBehavior+GestureListener, Syncfusion.SfChart.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
