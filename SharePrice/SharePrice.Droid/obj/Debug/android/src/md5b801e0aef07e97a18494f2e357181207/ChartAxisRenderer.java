...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.ChartAxisRenderer, Syncfusion.SfChart.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", ChartAxisRenderer.class, __md_methods);
	}


	public ChartAxisRenderer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == ChartAxisRenderer.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.ChartAxisRenderer, Syncfusion.SfChart.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public ChartAxisRenderer (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == ChartAxisRenderer.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.ChartAxisRenderer, Syncfusion.SfChart.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public ChartAxisRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == ChartAxisRenderer.class)
	...
	public ChartAxisRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == ChartAxisRenderer.class)
