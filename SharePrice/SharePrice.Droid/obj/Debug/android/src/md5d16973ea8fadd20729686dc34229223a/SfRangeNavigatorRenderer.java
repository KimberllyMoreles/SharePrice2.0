package md5d16973ea8fadd20729686dc34229223a;


public class SfRangeNavigatorRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Syncfusion.RangeNavigator.XForms.Droid.SfRangeNavigatorRenderer, Syncfusion.SfChart.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", SfRangeNavigatorRenderer.class, __md_methods);
	}


	public SfRangeNavigatorRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == SfRangeNavigatorRenderer.class)
			mono.android.TypeManager.Activate ("Syncfusion.RangeNavigator.XForms.Droid.SfRangeNavigatorRenderer, Syncfusion.SfChart.XForms.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public SfRangeNavigatorRenderer (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == SfRangeNavigatorRenderer.class)
	...
	public SfRangeNavigatorRenderer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == SfRangeNavigatorRenderer.class)
